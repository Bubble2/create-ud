...
const { chains, provider, webSocketProvider } = configureChains(
    SUPPORTED_CHAINS,
    [
        alchemyProvider({ apiKey: 'Mz3L5P0RaClqKS2RFrxSF2y9IxOSkec-' }), //apiKey目前用的是郭兆东注册的，可以自己去注册修改了
        infuraProvider({ apiKey: '7cc6d03a3f7b431cb319dcf7c2da9ab1' }),//apiKey目前用的是郭兆东注册的，可以自己去注册修改了
        publicProvider()
    ],
    { targetQuorum: 1 }
)
